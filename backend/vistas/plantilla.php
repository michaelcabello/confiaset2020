    ...
    /*=============================================
     ...
     if(isset($_GET["ruta"])){
        ...
        if($_GET["ruta"]== "inicio" ||
           ...
           $_GET["ruta"]== "blog" ||
           $_GET["ruta"]== "blognuevo" ||
           $_GET["ruta"]== "blogeditar" ||
           $_GET["ruta"]== "configuraciones" ||
           $_GET["ruta"]== "nosotros" ||
           $_GET["ruta"]== "subcategorias" ||
           $_GET["ruta"]== "subcategoriasd" ||
           $_GET["ruta"]== "categoriasblog" ||
           $_GET["ruta"]== "staff" ||
           $_GET["ruta"]== "contactos" ||
           $_GET["ruta"]== "seo" ||
           $_GET["ruta"]== "productos" ||
...
<script src="vistas/js/gestorCategoriasblog.js"></script>
<script src="vistas/js/gestorSubCategorias.js"></script>
<script src="vistas/js/gestorSubCategoriasd.js"></script>
<script src="vistas/js/gestorStaff.js"></script>
...
<script src="vistas/js/gestorConfiguraciones.js"></script>
<script src="vistas/js/gestorContactos.js"></script>
<script src="vistas/js/gestorSeo.js"></script>
