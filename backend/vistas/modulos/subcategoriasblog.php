  ...
  <section class="content">
    ...
    <div class="box">
       ...
       <!--=====================================
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <select class="form-control input-lg seleccionarCategoriaf">
      ...
      <div class="box-body">
       ...
       <table id="tablaSubCategorias" class="table table-bordered table-striped dt-responsive" width="100%">
        ...
        <div class="modal-body">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <img src="vistas/img/cabeceras/default/default.jpg" class="img-thumbnail previsualizarPortada" width="100%">
              <!-- el valor de previsualizar mostrara la foto de a BD -->
