...
if(isset($_GET["ruta"])){
    ...
    }else if($rutas[0] == "nosotros" || $rutas[0] == "infraestructura" || $rutas[0] == "staff" || $rutas[0] == "contactenos"){
...
<input type="hidden" value="<?php echo $url; ?>" id="rutaOculta">
	...
	<!-- Main Scripts-->
<!--    <script src="vistas/js/jquery.js"></script> --><!-- al activar esto no sale el menu quieto y el slider ya no funciona-->
...
<!-- estos scripts impedian el movimiento del slide--> 
